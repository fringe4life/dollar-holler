<script lang="ts">
  ...
  import { dummyInvoices, dummyClients } from '$lib/data'
</script>
...
<div class="mt-16 grid gap-y-16">
  ...
  >
    <div class="row-span-2 flex justify-center">
      <img src="/images/logo.svg" alt="Dollar Holler Logo" class="aspect-square" />
    </div>
    <h1
    ...
    <p class="hidden text-left text-gray-600 sm:block lg:text-xl">
      Streamline your invoicing and client management with our intuitive platform. Create
      professional invoices, track payments, and manage your client relationships all in one place.
      Get paid faster with Dollar Holler.
    </p>
  </header>

  <!-- Invoices Section -->
  <main class="grid gap-y-16">
    <section>
      <h2 class="font-sansserif text-daisyBush mb-8 text-3xl font-bold">Recent Invoices</h2>
      <InvoiceRowHeader />
    ...
    <!-- Clients Section -->
    <section>
      <h2 class="font-sansserif text-daisyBush mb-8 text-3xl font-bold">Active Clients</h2>
      <ClientRowHeader />
      <div class="flex flex-col-reverse gap-4">
