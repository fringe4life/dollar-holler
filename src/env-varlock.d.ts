...
type _CoercedEnvSchema_cb74388f = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_cb74388f> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_cb74388f, 'PUBLIC_BASE_URL'>> {}
}
...
type _EnvSchemaAsStrings_cb74388f = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_cb74388f {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_cb74388f {}
  }
}